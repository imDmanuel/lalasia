      ...
      <main>
        <section className="mt-24 2xl:mt-44">
          <div className="container">
            ...
            <div className="flex flex-col 2xl:flex-row max-xl:space-y-7 2xl:space-x-24 ">
        ...
        <section className="mt-24 2xl:mt-44">
          <div className="container">
            ...
            <div className="flex flex-col 2xl:flex-row 2xl:space-x-44 max-xl:space-y-4 mt-3 mb-12">
              <div>
